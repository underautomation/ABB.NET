...
namespace UnderAutomation.ABB.Rws {
	...
	public class RwsClient : RwsClientBase {
		...
		public void Connect(string ip, string username = "Default User", string password = "robotics", int port = 0, int timeout = 10000, bool useHttps = false, RwsVersion version)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
	}
