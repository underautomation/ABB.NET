...
namespace UnderAutomation.ABB.Rws.Services {
	...
	public class SystemService : Object {
		...
		/// <returns>Description of the system running on the controller</returns>
		public Task<SystemInfo> GetInfoAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Names of the options, in the order the controller reports them, empty when there is none</returns>
		public Task<string[]> GetOptionsAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Name of the license, for example &quot;VIRTUAL_USE&quot; on a simulated controller</returns>
		public Task<string> GetLicenseAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Robot types, for example &quot;IRB 120-3/0.6&quot;, empty when the controller drives no standard robot</returns>
		public Task<string[]> GetRobotTypesAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Installed products, empty when the controller reports none</returns>
		public Task<SystemProduct[]> GetProductsAsync(string name = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Energy measurement, broken down per mechanical unit and per axis</returns>
		public Task<SystemEnergy> GetEnergyAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public Nullable<int> GetEnergyChangeCount()
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Current value of the counter, null when the controller did not report it</returns>
		public Task<Nullable<int>> GetEnergyChangeCountAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ResetAccumulatedEnergyAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
