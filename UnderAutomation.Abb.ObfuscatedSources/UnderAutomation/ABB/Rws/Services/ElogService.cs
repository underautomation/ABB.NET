...
namespace UnderAutomation.ABB.Rws.Services {
	...
	public class ElogService {
		...
		/// <returns>Event log domains, ordered as the controller reports them</returns>
		public Task<ElogDomain[]> GetDomainsAsync(string language = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public ElogMessage[] GetMessages(int domain, ElogMessageOrder order = ElogMessageOrder.NewestFirst, string language = null, int? maxCount = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Messages of the domain, empty when the domain holds none</returns>
		public Task<ElogMessage[]> GetMessagesAsync(int domain, ElogMessageOrder order = ElogMessageOrder.NewestFirst, string language = null, int? maxCount = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public ElogMessage[] GetMessageTitles(int domain, string language, ElogMessageOrder order = ElogMessageOrder.NewestFirst, int? maxCount = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Messages of the domain, carrying their severity, code, timestamp and title only</returns>
		public Task<ElogMessage[]> GetMessageTitlesAsync(int domain, string language, ElogMessageOrder order = ElogMessageOrder.NewestFirst, int? maxCount = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The message</returns>
		public Task<ElogMessage> GetMessageAsync(int domain, int sequenceNumber, string language = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The message</returns>
		public Task<ElogMessage> GetMessageBySequenceNumberAsync(int sequenceNumber, string language = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ClearAllMessagesAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		///             "/fileservice/$home/elog.txt". Both spellings of an environment variable are accepted.</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SaveInSystemDumpFormatAsync(string path, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
