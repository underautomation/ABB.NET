...
namespace UnderAutomation.ABB.Rws.Services {
	...
	public class FileService : Object {
		...
		/// <returns>Directory listing containing files, subdirectories, and devices</returns>
		public Task<DirectoryListing> ListDirectoryAsync(string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="path">Path to the directory to delete (e.g. &quot;$home/testdir&quot;)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task DeleteDirectoryAsync(string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="newName">Name of the new directory (can be nested: &quot;dir1/dir2&quot;)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task CreateDirectoryAsync(string path, string newName, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="newName">New directory name (relative or absolute depending on controller behavior)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task RenameDirectoryAsync(string path, string newName, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="overwrite">Whether to overwrite if target exists</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task CopyDirectoryAsync(string path, string newName, bool overwrite, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="path">Path to the file to delete (e.g. &quot;$home/file.txt&quot;)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task DeleteFileAsync(string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="newName">New file name</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task RenameFileAsync(string path, string newName, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="overwrite">Whether to overwrite if target exists</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task CopyFileAsync(string path, string newName, bool overwrite, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>File content as byte array</returns>
		public Task<byte[]> GetFileAsBytesAsync(string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>File content as a readable stream</returns>
		public Task<Stream> GetFileAsReadonlyStreamAsync(string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>File content as string</returns>
		public Task<string> GetFileAsTextAsync(string path, Encoding encoding = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="localPath">Local file path to write</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task GetFileToDestinationAsync(string path, string localPath, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="contentType">Content type (default: application/octet-stream)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UploadFileFromBytesAsync(string path, byte[] content, string contentType = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="contentType">Content type (default: application/octet-stream)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UploadFileFromStreamAsync(string path, Stream contentStream, string contentType = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="encoding">Text encoding (UTF-8 if null)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UploadFileFromTextAsync(string path, string content, Encoding encoding = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="contentType">Content type (default: application/octet-stream)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UploadFileFromPathAsync(string path, string localPath, string contentType = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
