...
namespace UnderAutomation.ABB.Rws.Services {
	...
	/// 
	/// </summary>
	public class MotionSystemService : Object {
		...
		/// <returns>Calibration of the unit, with one entry per joint slot</returns>
		public Task<CalibrationInfo> GetCalibrationInfoAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per joint of the unit</returns>
		public Task<MotorCalibrationName[]> GetMotorCalibrationNamesAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Both copies of the measurement board data</returns>
		public Task<SmbData> GetSmbDataAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="direction">Which copy overwrites which</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetSmbDataAsync(string mechanicalUnit, SmbDataTransfer direction, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="memory">Which of the two copies to erase</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ClearSmbDataAsync(string mechanicalUnit, SmbDataMemory memory, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Overview of the motion system</returns>
		public Task<MotionSystemInfo> GetInfoAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the motion system changed since then, false when it did not</returns>
		public Task<bool> HasChangedAsync(int changeCount, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Error state of the motion system</returns>
		public Task<MotionSystemErrorState> GetErrorStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the motion instructions are skipped, false when the robot really moves</returns>
		public Task<bool> GetNonMotionExecutionModeAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="enabled">True to skip every motion instruction, false to let the robot move</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetNonMotionExecutionModeAsync(bool enabled, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when collision prediction is switched on</returns>
		public Task<bool> GetCollisionPredictionModeAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="enabled">True to predict collisions, false to switch the prediction off</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetCollisionPredictionModeAsync(bool enabled, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void Jog(RobotJoints axes, int changeCount, JogIncrementMode incrementMode)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// continuously for as long as the command is repeated</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task JogAsync(RobotJoints axes, int changeCount, JogIncrementMode incrementMode, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="mechanicalUnit">Name of the mechanical unit, for example &quot;ROB_1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetJoggingMechanicalUnitAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// axis values that travel with it</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetPositionTargetAsync(RobTarget target, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Pose the tool would be at, with the axis configuration and the external axis values</returns>
		public Task<RobTarget> GetPoseFromJointsAsync(string mechanicalUnit, Pose toolFrame, JointTarget joints, bool robotHoldsWorkObject = false, bool logErrors = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Joint values that reach the pose, in radians</returns>
		public Task<JointTarget> GetJointsFromCartesianAsync(string mechanicalUnit, Pose pose, ExternalJoints externalAxes, Pose toolFrame, JointTarget previousJoints, RobotConfiguration configuration, bool robotHoldsWorkObject = false, bool logErrors = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Joint values that reach the pose, in radians</returns>
		public Task<JointTarget> GetJointsFromPoseAsync(string mechanicalUnit, Pose pose, ExternalJoints externalAxes, Pose toolFrame, JointTarget previousJoints, RobotConfiguration configuration, bool robotHoldsWorkObject = false, bool logErrors = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <returns>One entry per solution, each with the joint values in radians and the axis configuration it
		/// corresponds to</returns>
		public Task<JointSolution[]> GetAllJointSolutionsAsync(string mechanicalUnit, Pose pose, ExternalJoints externalAxes, Pose toolFrame, RobotConfiguration configuration, bool robotHoldsWorkObject = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Mechanical units, with their activation state. Empty when the system declares none.</returns>
		public Task<MechanicalUnitItem[]> GetMechanicalUnitsAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Properties of the mechanical unit</returns>
		public Task<MechanicalUnitInfo> GetMechanicalUnitAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void SetMechanicalUnit(string mechanicalUnit, string tool = null, string workObject = null, string payload = null, string totalPayload = null, Nullable<MechanicalUnitMode> mode = null, Nullable<JogMode> jogMode = null, Nullable<CoordinateSystem> coordinateSystem = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// <param name="coordinateSystem">Reference frame the cartesian positions of the unit are expressed in</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetMechanicalUnitAsync(string mechanicalUnit, string tool = null, string workObject = null, string payload = null, string totalPayload = null, Nullable<MechanicalUnitMode> mode = null, Nullable<JogMode> jogMode = null, Nullable<CoordinateSystem> coordinateSystem = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Number of axes, which are numbered from 1 to that value</returns>
		public Task<int> GetAxisCountAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>State of the axis</returns>
		public Task<AxisInfo> GetAxisAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Position and orientation of the axis</returns>
		public Task<Pose> GetAxisPoseAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="pose">Position and orientation to declare for the axis</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetAxisPoseAsync(string mechanicalUnit, int axis, Pose pose, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="axis">Number of the axis, starting at 1</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task CommutateAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="axis">Number of the axis, starting at 1</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SynchronizeAxisRevolutionCounterAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="axis">Number of the axis, starting at 1</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UpdateRevolutionCounterAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="axis">Number of the axis, starting at 1</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task FineCalibrateAsync(string mechanicalUnit, int axis, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Base frame of the mechanical unit, with the kind of base it is</returns>
		public Task<BaseFrame> GetBaseFrameAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="baseFrame">Position and orientation of the base of the unit</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetBaseFrameAsync(string mechanicalUnit, Pose baseFrame, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RobTarget GetRobTarget(string mechanicalUnit, CoordinateSystem coordinateSystem, string tool = null, string workObject = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Position, orientation, axis configuration and external axis values of the tool</returns>
		public Task<RobTarget> GetRobTargetAsync(string mechanicalUnit, CoordinateSystem coordinateSystem, string tool = null, string workObject = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RobTarget GetCartesianPosition(string mechanicalUnit, CoordinateSystem coordinateSystem, string tool = null, string workObject = null, bool logErrors = false)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public Task<RobTarget> GetCartesianPositionAsync(string mechanicalUnit, CoordinateSystem coordinateSystem, string tool = null, string workObject = null, bool logErrors = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Joint values of the six robot axes and of the six external axes</returns>
		public Task<JointTarget> GetJointTargetAsync(string mechanicalUnit, bool alwaysRead = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Physical value of the six axes</returns>
		public Task<RobotJoints> GetPhysicalJointsAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="position">Joint values to place the unit at, robot axes in degrees</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetMechanicalUnitPositionAsync(string mechanicalUnit, JointTarget position, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the arm gives way when pushed</returns>
		public Task<LeadThroughStatus> GetLeadThroughAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="active">True to let the arm give way when pushed, false to have it hold its position</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetLeadThroughAsync(string mechanicalUnit, bool active, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the supervision is switched on, and how sensitive it is</returns>
		public Task<MotionSupervision> GetMotionSupervisionAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="enabled">True to watch for collisions while the unit is jogged, false to stop watching</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetMotionSupervisionModeAsync(string mechanicalUnit, bool enabled, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// is reported</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetMotionSupervisionLevelAsync(string mechanicalUnit, int sensitivity, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the supervision is switched on, and how sensitive it is</returns>
		public Task<PathSupervision> GetPathSupervisionAsync(string mechanicalUnit, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="enabled">True to watch for collisions along the programmed path, false to stop watching</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetPathSupervisionModeAsync(string mechanicalUnit, bool enabled, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// is reported</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetPathSupervisionLevelAsync(string mechanicalUnit, int level, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
