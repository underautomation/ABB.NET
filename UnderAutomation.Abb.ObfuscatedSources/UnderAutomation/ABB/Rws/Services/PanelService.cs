...
namespace UnderAutomation.ABB.Rws.Services {
	...
	public class PanelService : Object {
		...
		/// <returns>State of the controller, <xref href="UnderAutomation.ABB.Rws.Data.ControllerState.Unknown" data-throw-if-not-resolved="false"></xref> when it reports a state this library does not know</returns>
		public Task<ControllerState> GetControllerStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="state">
		/// State to switch to, which can only be <xref href="UnderAutomation.ABB.Rws.Data.ControllerState.MotorsOn" data-throw-if-not-resolved="false"></xref> or <xref href="UnderAutomation.ABB.Rws.Data.ControllerState.MotorsOff" data-throw-if-not-resolved="false"></xref>.
		/// Every other state is reached by the controller on its own and cannot be requested.
		/// </param>
		...
		/// </param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetControllerStateAsync(ControllerState state, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Operating mode, <xref href="UnderAutomation.ABB.Rws.Data.OperationMode.Unknown" data-throw-if-not-resolved="false"></xref> when the controller reports a mode this library does not know</returns>
		public Task<OperationMode> GetOperationModeAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="acknowledgement">Change to confirm</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task AcknowledgeOperationModeAsync(OperationModeAcknowledgement acknowledgement, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Lock state, <xref href="UnderAutomation.ABB.Rws.Data.OperationModeLockState.Unknown" data-throw-if-not-resolved="false"></xref> when the controller reports a state this library does not know</returns>
		public Task<OperationModeLockState> GetOperationModeLockStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// When true, the selector is locked permanently, which requires the key-less mode selector grant.
		/// When false (default), the lock can be released with <xref href="UnderAutomation.ABB.Rws.Services.PanelService.UnlockOperationMode(System.String)" data-throw-if-not-resolved="false"></xref>.
		/// </param>
		...
		/// <param name="permanent">
		/// When true, the selector is locked permanently, which requires the key-less mode selector grant.
		/// When false (default), the lock can be released with <xref href="UnderAutomation.ABB.Rws.Services.PanelService.UnlockOperationModeAsync(System.String%2cSystem.Threading.CancellationToken)" data-throw-if-not-resolved="false"></xref>.
		/// </param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task LockOperationModeAsync(string pin, bool permanent = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="pin">Four digit pin code the selector was locked with</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UnlockOperationModeAsync(string pin, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Speed ratio, as a percentage between 0 and 100</returns>
		public Task<int> GetSpeedRatioAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// A connection established with version 2 requires mastership to change the speed ratio. When true (default),
		/// mastership is taken implicitly for this request. Ignored on a version 1 connection, which needs none.
		/// </param>
		...
		/// </param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetSpeedRatioAsync(int speedRatio, bool useImplicitMastership = true, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <returns>Collision detection state, <xref href="UnderAutomation.ABB.Rws.Data.CollisionDetectionState.Unknown" data-throw-if-not-resolved="false"></xref> when the controller reports
		/// a state this library does not know</returns>
		public Task<CollisionDetectionState> GetCollisionDetectionStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="languageCode">Two letter language code, for example &quot;en&quot;, &quot;sv&quot; or &quot;de&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetLanguageAsync(string languageCode, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="mode">
		/// How the controller restarts. The control panel accepts <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.Restart" data-throw-if-not-resolved="false"></xref>,
		...
		/// <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.BStart" data-throw-if-not-resolved="false"></xref>; use <xref href="UnderAutomation.ABB.Rws.Services.ControllerService.Restart(UnderAutomation.ABB.Rws.Data.ControllerRestartMode%2cSystem.Boolean)" data-throw-if-not-resolved="false"></xref> for the others.
		/// </param>
		/// <param name="useImplicitMastership">
		...
		/// How the controller restarts. The control panel accepts <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.Restart" data-throw-if-not-resolved="false"></xref>,
		/// <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.IStart" data-throw-if-not-resolved="false"></xref>, <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.PStart" data-throw-if-not-resolved="false"></xref> and
		/// <xref href="UnderAutomation.ABB.Rws.Data.ControllerRestartMode.BStart" data-throw-if-not-resolved="false"></xref>; use <xref href="UnderAutomation.ABB.Rws.Services.ControllerService.RestartAsync(UnderAutomation.ABB.Rws.Data.ControllerRestartMode%2cSystem.Boolean%2cSystem.Threading.CancellationToken)" data-throw-if-not-resolved="false"></xref> for the others.
		/// </param>
		/// <param name="useImplicitMastership">
		/// A connection established with version 2 requires mastership on all domains to restart the controller. When true
		/// (default), mastership is taken implicitly for this request. Ignored on a version 1 connection, which needs none.
