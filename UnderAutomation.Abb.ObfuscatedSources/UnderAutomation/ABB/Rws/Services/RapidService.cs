...
namespace UnderAutomation.ABB.Rws.Services {
	...
	/// 
	/// </summary>
	public class RapidService : Object {
		...
		/// <returns>Execution state of the controller</returns>
		public Task<RapidExecutionInfo> GetExecutionStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void Start(RapidRegainMode regain, RapidExecutionMode executionMode, RapidExecutionCycle cycle, RapidStartCondition condition, bool stopAtBreakpoint = false, bool allTasksBySelection = false)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// rather than the normal tasks only</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task StartAsync(RapidRegainMode regain, RapidExecutionMode executionMode, RapidExecutionCycle cycle, RapidStartCondition condition, bool stopAtBreakpoint = false, bool allTasksBySelection = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task StartFromProductionEntryAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void Stop(RapidStopMode stopMode, RapidTaskScope scope)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// <param name="scope">Whether the command applies to the normal tasks only or to every task</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task StopAsync(RapidStopMode stopMode, RapidTaskScope scope, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ResetProgramPointerAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <xref href="UnderAutomation.ABB.Rws.Data.RapidExecutionCycle.Forever" data-throw-if-not-resolved="false"></xref> are accepted</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetExecutionCycleAsync(RapidExecutionCycle cycle, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="state">State to put the control in</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetHoldToRunAsync(RapidHoldToRunState state, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per task the panel shows</returns>
		public Task<RapidTaskSelectionItem[]> GetTaskSelectionAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidAliasIoItem[] GetAliasIo(Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per alias, empty when no loaded program declares any</returns>
		public Task<RapidAliasIoItem[]> GetAliasIoAsync(Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per module</returns>
		public Task<RapidModuleItem[]> GetModulesAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>State of the module</returns>
		public Task<RapidModuleInfo> GetModuleAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Change counter of the module</returns>
		public Task<int> GetModuleChangeCountAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Size of the module</returns>
		public Task<RapidModuleExtension> GetModuleExtensionAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Source of the module and the counters that go with it</returns>
		public Task<RapidModuleText> GetModuleTextAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="text">New source of the module</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetModuleTextAsync(string task, string module, string text, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The requested source</returns>
		public Task<string> GetModuleTextRangeAsync(string task, string module, int startRow, int startColumn, int endRow, int endColumn, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>What the controller did with the change, including the name the module ended up with</returns>
		public Task<RapidSetTextRangeResult> SetModuleTextRangeAsync(string task, string module, RapidTextReplaceMode replaceMode, RapidTextQueryMode queryMode, int startRow, int startColumn, int endRow, int endColumn, string text, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Where the text was found; its <code>Found</code> property is false when it was not</returns>
		public Task<RapidTextPosition> SearchModuleTextAsync(string task, string module, string text, int startRow = 1, int startColumn = 1, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the persistent variables are synchronized</returns>
		public Task<bool> GetSyncPersStatusAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="module">Name of the module, for example &quot;MainModule&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SyncPersistentVariablesAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// controller such as its home or temporary directory</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SaveModuleAsync(string task, string module, string name, string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The properties of the request the module accepts</returns>
		public Task<RapidModuleAttribute[]> GetPossibleModuleAttributesAsync(string task, string module, RapidModuleAttribute[] attributes, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The declaration, null when there is none at that position</returns>
		public Task<RapidModuleSymbol> GetModuleSymbolAsync(string task, string module, int row, int column, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The routine called at that position</returns>
		public Task<RapidRoutineInfo> GetRoutineAsync(string task, string module, int row, int column, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidRoutineArgument[] GetRoutineArguments(string task, string module, int row, int column, Nullable<int> mark = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per argument</returns>
		public Task<RapidRoutineArgument[]> GetRoutineArgumentsAsync(string task, string module, int row, int column, Nullable<int> mark = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidInstructionTemplate GetInstructionTemplate(string task, string module, string name, bool isDataType = false, Nullable<int> row = null, Nullable<int> column = null, Nullable<int> parameterNumber = null, Nullable<int> alternativeNumber = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The suggested template</returns>
		public Task<RapidInstructionTemplate> GetInstructionTemplateAsync(string task, string module, string name, bool isDataType = false, Nullable<int> row = null, Nullable<int> column = null, Nullable<int> parameterNumber = null, Nullable<int> alternativeNumber = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The parts of the object</returns>
		public Task<RapidObjectChild> GetObjectChildrenAsync(string task, string module, int startLine, int startColumn, int endLine, int endColumn, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>How many instructions can be rewritten, and which range they cover</returns>
		public Task<RapidModifiablePositions> GetModifiablePositionsAsync(string task, string module, int startRow, int startColumn, int endRow, int endColumn, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per instruction, empty when the controller found none</returns>
		public Task<RapidModifiablePositionItem[]> GetAllModifiablePositionsAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="allowDeactivated">Whether a deactivated axis is rewritten anyway</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ModifyPositionAsync(string task, string module, int startRow, int startColumn, int endRow, int endColumn, bool checkLimits = true, bool checkDeactivatedAxes = true, bool allowDeactivated = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="checkDeactivatedAxes">Whether the controller refuses to rewrite an axis that is deactivated</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ModifyAllPositionsAsync(bool checkLimits = true, bool checkDeactivatedAxes = true, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Position, orientation, configuration and external axes of the tool</returns>
		public Task<RobTarget> GetRobTargetAsync(string task, string tool = null, string workObject = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Values of the six robot axes and of the external axes</returns>
		public Task<JointTarget> GetJointTargetAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>State of each external joint</returns>
		public Task<RapidExternalJointStates> GetExternalJointStatesAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per unit the task can move</returns>
		public Task<RapidMechanicalUnitItem[]> GetMechanicalUnitsAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The loaded program, null when the task holds none</returns>
		public Task<RapidProgramInfo> GetProgramAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void LoadProgram(string task, string programPath, RapidProgramLoadMode loadMode)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// <param name="loadMode">What happens to the modules the task already holds</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task LoadProgramAsync(string task, string programPath, RapidProgramLoadMode loadMode, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UnloadProgramAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="path">Directory to save the program into, for example &quot;$HOME/myprograms&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SaveProgramAsync(string task, string path, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="name">New name of the program</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramNameAsync(string task, string name, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="routine">Name of the routine, for example &quot;main&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetEntryPointAsync(string task, string routine, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidBreakpoint[] GetBreakpoints(string task, Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per breakpoint, empty when the program carries none</returns>
		public Task<RapidBreakpoint[]> GetBreakpointsAsync(string task, Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The breakpoint as the controller placed it</returns>
		public Task<RapidBreakpoint> SetBreakpointAsync(string task, string module, int row, int column, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidBuildError[] GetBuildErrors(string task, Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per error, empty when the program linked cleanly</returns>
		public Task<RapidBuildError[]> GetBuildErrorsAsync(string task, Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Position of the program pointer</returns>
		public Task<RapidProgramCounterPosition> GetProgramCounterPositionAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The two pointers of the task</returns>
		public Task<RapidPointers> GetPointersAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="column">Column to move the pointer to, counted from 1</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramPointerToCursorAsync(string task, string module, string routine, int row, int column, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// routine has to be started with</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramPointerToRoutineAsync(string task, string module, string routine, bool userLevel = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// routine has to be started with</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramPointerToRoutineUrlAsync(string task, string routineUrl, bool userLevel = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramPointerToNextInstructionAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetProgramPointerToPreviousInstructionAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Declaration of the symbol</returns>
		public Task<RapidSymbolProperties> GetSymbolPropertiesAsync(string symbolUrl, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Value of the symbol, written the way RAPID writes it</returns>
		public Task<RapidSymbolValue> GetSymbolValueAsync(string symbolUrl, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// for example &quot;[[515,0,712],[1,0,0,0],[0,0,0,0],[9E9,9E9,9E9,9E9,9E9,9E9]]&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetSymbolValueAsync(string symbolUrl, string value, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="value">New initial value, written the way RAPID writes it</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetSymbolInitialValueAsync(string symbolUrl, string value, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per symbol found, empty when none matched</returns>
		public Task<RapidSymbolProperties[]> SearchSymbolsAsync(RapidSymbolSearchCriteria criteria, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the controller accepts the value, false when it rejects it</returns>
		public Task<bool> ValidateSymbolValueAsync(string task, string dataType, string value, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidObjectListExtension GetObjectListExtension(string symbolUrl, RapidObjectListType type)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Where the list and its ends sit</returns>
		public Task<RapidObjectListExtension> GetObjectListExtensionAsync(string symbolUrl, RapidObjectListType type, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per task</returns>
		public Task<RapidTaskItem[]> GetTasksAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>State of the task</returns>
		public Task<RapidTaskInfo> GetTaskAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ActivateTasksAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task DeactivateTasksAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task ActivateTaskAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task DeactivateTaskAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task BuildTaskAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="task">Name of the task, for example &quot;T_ROB1&quot;</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task AbortExecutionLevelAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Name of the loaded module, null when the controller did not report it</returns>
		public Task<string> LoadModuleAsync(string task, string modulePath, bool replace = false, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="module">Name of the module to unload</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task UnloadModuleAsync(string task, string module, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the trace is being written</returns>
		public Task<RapidSpyStatus> GetSpyStatusAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// no directory of its own</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task StartSpyAsync(string logFile, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task StopSpyAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the program pointers are synchronized</returns>
		public Task<RapidPointerSyncState> GetProgramPointerSyncStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the motion pointers are synchronized</returns>
		public Task<RapidPointerSyncState> GetMotionPointerSyncStateAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the program pointer of the task is synchronized</returns>
		public Task<RapidPointerSyncState> GetTaskProgramPointerSyncStateAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Whether the motion pointer of the task is synchronized</returns>
		public Task<RapidPointerSyncState> GetTaskMotionPointerSyncStateAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Change counters of the task</returns>
		public Task<RapidStructuralChangeCount> GetStructuralChangeCountAsync(string task, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The requested stack frame</returns>
		public Task<RapidActivationRecord> GetActivationRecordAsync(string task, int stackFrame = 1, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidServiceRoutineItem[] GetServiceRoutines(string task, Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per routine</returns>
		public Task<RapidServiceRoutineItem[]> GetServiceRoutinesAsync(string task, Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per suggested type</returns>
		public Task<RapidPreferredDataTypeItem[]> GetPreferredDataTypesAsync(string task, string instruction, string parameter, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidPalletHeadItem[] GetPalletHeads(string task, Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public Task<RapidPalletHeadItem[]> GetPalletHeadsAsync(string task, Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RapidPalletItem[] GetPallet(string task, int palletNumber, Nullable<int> start = null, Nullable<int> limit = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per instruction of the category</returns>
		public Task<RapidPalletItem[]> GetPalletAsync(string task, int palletNumber, Nullable<int> start = null, Nullable<int> limit = null, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>The pending instruction, null when the program is not asking for anything</returns>
		public Task<RapidUiInstruction> GetActiveUiInstructionAsync(CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>One entry per parameter</returns>
		public Task<RapidUiInstructionParameter[]> GetUiInstructionParametersAsync(string stackUrl, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Value of the parameter, written the way RAPID writes it</returns>
		public Task<string> GetUiInstructionParameterAsync(string stackUrl, string parameter, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="value">Value to write, written the way RAPID writes it</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetUiInstructionParameterAsync(string stackUrl, string parameter, string value, CancellationToken cancellationToken = null)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
