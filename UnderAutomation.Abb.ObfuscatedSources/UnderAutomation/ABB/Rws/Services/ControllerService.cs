...
namespace UnderAutomation.ABB.Rws.Services {
	...
	public class ControllerService {
		...
		/// <returns>Controller information</returns>
		public Task<ControllerInfo> GetInfoAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Value of the environment variable (e.g. "/hd0a/TEMP")</returns>
		public Task<string> GetEnvironmentVariableAsync(string name, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Current controller time (UTC)</returns>
		public Task<DateTime> GetClockAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="dateTime">New controller date and time (UTC)</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetClockAsync(DateTime dateTime, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Time zone as defined by the tz database, for example "Europe/Stockholm"</returns>
		public Task<string> GetTimeZoneAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="timeZone">Time zone as defined by the tz database, for example "Europe/Stockholm"</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetTimeZoneAsync(string timeZone, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Time server information, or null when no time server is configured</returns>
		public Task<TimeServerInfo> GetTimeServerAsync(string serverIp = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="timeServer">Address of the time server, for example "132.163.4.101"</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetTimeServerAsync(string timeServer, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Controller identity</returns>
		public Task<ControllerIdentity> GetIdentityAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="id">New controller id, null to leave it unchanged</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetIdentityAsync(string name, string id = null, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Network interfaces of the controller</returns>
		public Task<NetworkInterfaceItem[]> GetNetworkInterfacesAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Names of the installed systems</returns>
		public Task<string[]> GetInstalledSystemsAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the option is installed on the controller, false otherwise</returns>
		public Task<bool> HasOptionAsync(string option, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>True when the RobotWare version is compatible with the controller hardware</returns>
		public Task<bool> IsRobotWareVersionCompatibleAsync(string robotWareVersion, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Names of the backup sub resources ("backup-info", "backup-state", "check-restore")</returns>
		public Task<string[]> GetBackupResourcesAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Name, versions and options of the backed up system</returns>
		public Task<BackupSystemInfo> GetBackupInfoAsync(string backupPath, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Current backup state</returns>
		public Task<BackupState> GetBackupStateAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// be created under the $HOME directory, nor use the name of an environment variable directory.</param>
		...
		/// <param name="archive">When true, the backup is stored as an archive</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task CreateBackupAsync(string backupPath, bool archive = false, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public void RestoreBackup(string backupPath, BackupRestoreIgnore ignore = BackupRestoreIgnore.None, bool deleteDirectory = true, bool includeControllerSettings = true, bool includeSafetySettings = true, BackupRestoreInclude include = BackupRestoreInclude.All)
		{
			// Source is hidden, a Source licence is needed to access internal code...
		}
		...
		/// <param name="include">Content to restore</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task RestoreBackupAsync(string backupPath, BackupRestoreIgnore ignore = BackupRestoreIgnore.None, bool deleteDirectory = true, bool includeControllerSettings = true, bool includeSafetySettings = true, BackupRestoreInclude include = BackupRestoreInclude.All, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public CheckRestoreResult CheckRestore(string backupPath, BackupRestoreIgnore ignore = BackupRestoreIgnore.None, bool includeControllerSettings = true, bool includeSafetySettings = true, BackupRestoreInclude include = BackupRestoreInclude.All)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Result of the check, including the missing or corrupted file when the controller reports one</returns>
		public Task<CheckRestoreResult> CheckRestoreAsync(string backupPath, BackupRestoreIgnore ignore = BackupRestoreIgnore.None, bool includeControllerSettings = true, bool includeSafetySettings = true, BackupRestoreInclude include = BackupRestoreInclude.All, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Names of the safety sub resources ("safety-mode", "safety-configuration", "violation-info", ...)</returns>
		public Task<string[]> GetSafetyResourcesAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Current safety mode and its user data</returns>
		public Task<SafetyModeStatus> GetSafetyModeAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Versions, creation date and checksum of the safety configuration</returns>
		public Task<SafetyConfiguration> GetSafetyConfigurationAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="filePath">Path of the safety configuration file on the controller (e.g. "$home/file.xml")</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task LoadSafetyConfigurationAsync(string filePath, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task InvalidateSafetyConfigurationAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Cyclic brake check status of the mechanical unit</returns>
		public Task<CyclicBrakeCheckStatus> GetCyclicBrakeCheckStatusAsync(int driveNumber, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Safety violation details</returns>
		public Task<SafetyViolationInfo> GetSafetyViolationInfoAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Names of the virtual time sub resources ("vttime", "vtspeed", "vtstate", "vttimeslice")</returns>
		public Task<string[]> GetVirtualTimeResourcesAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Virtual time in milliseconds</returns>
		public Task<long> GetVirtualTimeAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Speed of the virtual time in percent</returns>
		public Task<int> GetVirtualTimeSpeedAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="speed">Speed in percent, or -1 for full speed</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetVirtualTimeSpeedAsync(int speed, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>State of the virtual time server</returns>
		public Task<VirtualTimeState> GetVirtualTimeStateAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="state">New state of the virtual time server</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetVirtualTimeStateAsync(VirtualTimeState state, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="cancellationToken">Cancellation token</param>
		/// <returns>Time slice in milliseconds</returns>
		public Task<int> GetVirtualTimeSliceAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// <param name="milliseconds">Time slice in milliseconds</param>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task SetVirtualTimeSliceAsync(int milliseconds, CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		/// </summary>
		/// <param name="cancellationToken">Cancellation token</param>
		public Task RunVirtualTimeAsync(CancellationToken cancellationToken = default)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
