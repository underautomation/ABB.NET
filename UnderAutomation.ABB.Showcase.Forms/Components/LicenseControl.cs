...
public partial class LicenseControl : UserControl, IUserControl
{
    ...
    public LicenseControl()
    {
        ...
        AbbController.RegisterLicense(Config.Current.Licensee, Config.Current.Key);
    ...
    private void UpdateLicenseControls()
    {
        ...
        var info = AbbController.LicenseInfo;
    ...
    private void btnSetLicense_Click(object sender, System.EventArgs e)
    {
        ...
        AbbController.RegisterLicense(txtLicensee.Text, txtKey.Text);
    ...
    {
        MainForm.Instance.OpenUrl($"{(sender as Control).Text}?sdk=ABB");
    }
}
